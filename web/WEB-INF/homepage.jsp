...
<script type="text/javascript">
    ...
    function showMod(id) {
        ...
        url = "alterUser.jsp?id=" + id;//弹出窗口页内容
        var oOpen = window.open(url, "adviceDetail", model);
        oOpen.focus();
    }
</script>
...
<body>
<h2 align="center" style="margin-top: 30px">用户界面</h2>
<table align="center" style="margin-top:30px;line-height: 50px;text-align:center;width:70%">
    <tr>
        <td></td>
        <td cols="3">
        ...
        <td></td>
        <td><input type="submit" class="btn btn-primary" value="查 找"/>
            </form></td>
        <td></td>
        <td></td>
